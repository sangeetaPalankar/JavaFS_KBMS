...
public class Order {
	...
	public Order(int orderId, int productId, int quantity, double totalPrice, String orderDate, String status,
			String cancellationId, String cancellationDate, String cancellationReason, String preffered_login_Id,
			String productName) {
		super();
	...
	public String toString() {
		return "Order [orderId=" + orderId + ", productId=" + productId + ", quantity=" + quantity + ", totalPrice="
				...
				+ ", preffered_login_Id=" + preffered_login_Id + ", productName=" + productName + "]";
	}
